package com.example.asoft.flatmapdemo;
...
//                        })
                        ...
                        Оператор map принимает объект и отдает объект такого же класса (Student -> Student)
                        Оператор flatMap принимает объект и отдает Observable (item -> Observable)
