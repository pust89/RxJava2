...
public class TodolistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       compositeDisposable.add( RxTextView.textChangeEvents(searchEditText)
                .skipInitialValue()      //Avoid receiving default value
                .debounce(450, TimeUnit.MILLISECONDS) //Delay before emitting 450ms
                .distinctUntilChanged()//Returns an Observable that emits all items emitted by the
                                        // source ObservableSource that are distinct from their
